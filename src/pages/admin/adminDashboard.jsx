...
const AdminDashboard = () => {
  ...
  const hasPurchaseData = purchaseData.some(item => item.courses > 0);
  const hasAnyChartData = hasRevenueData || hasPurchaseData;
  ...
  return (
    <Stack className="p-4 md:p-6" gap="xl">
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex items-start sm:items-center gap-3">
                    ...
                    <div>
                      <Text fw={600} size="sm">{tutor.fullName}</Text>
      ...
      {/* ✅ ADDED: ONLY SHOW IF DATA EXISTS */}
      {hasAnyChartData && (
        <Card shadow="sm" radius="md" withBorder p="lg">
